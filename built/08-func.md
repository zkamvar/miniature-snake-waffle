---
sandpaper-digest: 790441dbcc18d2e9f45a6edae8b60268
...
[body](reference/#body) of the function --- the
...
Inside the function,
we use a [return statement](reference/#return-statement) to send a result
...
Instead,
we can [compose](reference/#compose) the two functions we have already created:
...
we should write some [documentation](reference/#documentation) for our function
to remind ourselves later what it's for and how to use it.

The usual way to put documentation in software is
to add [comments](reference/#comment) like this:
...
A string like this is called a [docstring](reference/#docstring).
...
the [default value](reference/#default-value) of 0.0:
