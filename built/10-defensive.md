---
sandpaper-digest: 233ceccd8476bdf8cc699b07a3a72b78
...
This is called [defensive programming](reference/#defensive-programming),
and the most common way to do it is to add
[assertions](reference/#assertion) to our code
...
Writing assertions to check that you haven't [regressed](reference/#regression)
...
is called [test-driven development](reference/#test-driven-development) (TDD.
